...
namespace WEBPJ.Controllers
{
    public class CompraController : Controller
    {
        ...
        List<Compra_Info> lst_PrecioJusto = new List<Compra_Info>();
        ...
        public ActionResult Index()
        {
            ...
            List<Compra_Info> lst_PrecioJusto = data_compra.get_list(model.fecha_ini, model.fecha_fin, model.IdUsuario, model.Estado);
            Lista_Compra.set_list(lst_PrecioJusto, model.IdTransaccionSession);
        ...
        {
            //Lista_Compra.get_list(model.IdTransaccionSession);
            List<Compra_Info> lst_PrecioJusto = data_compra.get_list(model.fecha_ini, model.fecha_fin, model.IdUsuario, model.Estado);
            Lista_Compra.set_list(lst_PrecioJusto, model.IdTransaccionSession);
            cargar_combos_consulta();
            return View(model);
        ...
        public ActionResult GridViewPartial_Compra(DateTime? Fecha_ini, DateTime? Fecha_fin, string IdUsuario = "", string Estado = "")
        {
            ...
            //Lista_Compra.set_list(lst_PrecioJusto, Convert.ToDecimal(SessionFixed.IdTransaccionSessionActual));
            List<Compra_Info> lst_PrecioJusto = Lista_Compra.get_list(Convert.ToDecimal(SessionFixed.IdTransaccionSessionActual));
            return PartialView("_GridViewPartial_Compra");
        }
        ...
        public JsonResult GuardarLista(decimal IdTransaccionSession = 0)
        {
            ...
            if (IdTransaccionSession > 0)
            {
                SessionFixed.IdTransaccionSessionActual = Request.Params["TransaccionFixed"] != null ? Request.Params["TransaccionFixed"].ToString() : SessionFixed.IdTransaccionSessionActual;
                List<Compra_Info> lst_PrecioJusto = Lista_Compra.get_list(Convert.ToDecimal(SessionFixed.IdTransaccionSessionActual));
                resultado = data_compra.ModificarBD(lst_PrecioJusto);
    ...
    public class Compra_List
    {
        ...
        {
            List<Compra_Info> edited_info1 = get_list(IdTransaccionSession);
